...
<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=180&section=header&text=PUC%20HUB&fontSize=75&fontColor=f39c12&animation=fadeIn&fontAlignY=38&desc=The%20All-in-One%20Student%20Portal%20for%20Premier%20University%20Chittagong&descAlignY=60&descAlign=50&descSize=15&descColor=e67e22" width="100%"/>
...
<img src="https://img.shields.io/badge/Version-1.0.0-f39c12?style=flat-square&labelColor=1a1a2e"/>
<img src="https://img.shields.io/badge/License-MIT-3498db?style=flat-square&labelColor=1a1a2e"/>
<img src="https://img.shields.io/badge/Platform-Web-e67e22?style=flat-square&labelColor=1a1a2e"/>
</p>
...
graph TD
    ...
    B --> B1[Question Bank]
    B --> B2[PUC AI Assistant]
    B --> B3[Cover Page Generator]
    B --> B4[Blood Donation]
    B --> B5[CP Leaderboard]
    B --> B6[Routine Generator]

    C --> C1[Mess and Housing]
    C --> C2[Fee Calculator]
    C --> C3[Faculty Contacts]
    C --> C4[CGPA Calculator]
    C --> C5[Holiday Calendar]

    D --> D1[Class Routine]
    D --> D2[Exam Routine]
    D --> D3[Notice Board]
    D --> D4[Club Information]
    D --> D5[Bus Route Map]

    E --> E1[Study Partner Finder]
    E --> E2[University Room Info]
    E --> E3[YouTube Playlists]
    E --> E4[Learning Resources]

    F --> F1[AI Study Tracker]
    F --> F2[Notes Summarizer]
    F --> F3[Code Debugger]
    F --> F4[Assignment Writer]

    style A fill:#f39c12,color:#000,stroke:#e67e22
    style B fill:#3498db,color:#fff,stroke:#2980b9
    style C fill:#1abc9c,color:#fff,stroke:#16a085
    style D fill:#95a5a6,color:#fff,stroke:#7f8c8d
    style E fill:#27ae60,color:#fff,stroke:#229954
...
flowchart LR
    subgraph Frontend
        H[HTML5] & C[CSS3] & J[JavaScript]
    end
    subgraph JS_Modules
        auth.js & routes.js & tracker.js & profile.js & app.js
    end
    subgraph Backend
        login.php & profile.php & track.php & config.php
    end
    subgraph Database
        users & login_logs & activity_logs
    end
    Frontend --> Backend
    Backend --> Database
    J --> JS_Modules
